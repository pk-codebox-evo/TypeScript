...
verify.quickInfoAt("16q", "function sum(a: number, b: number): number", "Adds two integers and returns the result");
verify.quickInfoAt("16aq", "(parameter) a: number", "first number");
...
verify.currentParameterHelpArgumentDocCommentIs("first number");
verify.quickInfoAt("19q", "function multiply(a: number, b: number, c?: number, d?: any, e?: any): void", "This is multiplication function\n@anotherTag\n@anotherTag");
verify.quickInfoAt("19aq", "(parameter) a: number", "first number");
...
verify.currentParameterHelpArgumentDocCommentIs("");
verify.quickInfoAt("25q", "function f1(a: number): any (+1 overload)", "fn f1 with number");
verify.quickInfoAt("25aq", "(parameter) a: number", "");

goTo.marker('26');
verify.currentSignatureHelpDocCommentIs("");
verify.currentParameterHelpArgumentDocCommentIs("");
verify.quickInfoAt("26q", "function f1(b: string): any (+1 overload)", "");
verify.quickInfoAt("26aq", "(parameter) b: string", "");
...
verify.currentParameterHelpArgumentDocCommentIs("");
verify.quickInfoAt("28q", "function subtract(a: number, b: number, c?: () => string, d?: () => string, e?: () => string, f?: () => string): void", "This is subtract function");
verify.quickInfoAt("28aq", "(parameter) a: number", "");
...
verify.quickInfoAt("34q", "function square(a: number): number", "this is square function\n@paramTag { number } a this is input number of paramTag\n@returnType { number } it is return type");
verify.quickInfoAt("34aq", "(parameter) a: number", "this is input number");

goTo.marker('35');
verify.currentSignatureHelpDocCommentIs("this is divide function\n@paramTag { number } g this is optional param g");
verify.currentParameterHelpArgumentDocCommentIs("this is a");
verify.quickInfoAt("35q", "function divide(a: number, b: number): void", "this is divide function\n@paramTag { number } g this is optional param g");
verify.quickInfoAt("35aq", "(parameter) a: number", "this is a");
...
verify.quickInfoAt("37q", "function fooBar(foo: string, bar: string): string", "Function returns string concat of foo and bar");
verify.quickInfoAt("37aq", "(parameter) foo: string", "is string");
...
verify.quickInfoAt("40q", "function jsDocParamTest(a: number, b: number, c: number, d: number): number", "this is jsdoc style function with param tag as well as inline parameter help");
verify.quickInfoAt("40aq", "(parameter) a: number", "it is first parameter\nthis is inline comment for a ");
...
verify.quickInfoAt("47q", "function jsDocCommentAlignmentTest3(a: string, b: any, c: any): void", "This is function comment\n    And aligned with 4 space char margin");
verify.quickInfoAt("47aq", "(parameter) a: string", "this is info about a\nspanning on two lines and aligned perfectly");
...
verify.currentSignatureHelpDocCommentIs("This is function comment\n    And aligned with 4 space char margin");
verify.currentParameterHelpArgumentDocCommentIs("this is info about b\nnot aligned text about parameter will eat only one space");
verify.quickInfoAt("49aq", "(parameter) c: any", "this is info about b\nnot aligned text about parameter will eat only one space");

verify.quickInfoAt("50", "class NoQuickInfoClass", "");
