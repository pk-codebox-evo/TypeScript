...
goTo.marker('9');
verify.currentSignatureHelpDocCommentIs("");
verify.quickInfoAt("9q", "var fooVar: () => void", "");
verify.quickInfoAt("9aq", "var fooVar: () => void", "fooVar comment");
...
verify.quickInfoAt("12", "var fooVar: () => void", "fooVar comment");

verify.quickInfoAt("13", "var fooVar: () => void", "fooVar comment");

verify.quickInfoAt("14", "function foo(): void", "foos comment");

verify.quickInfoAt("15", "function foo2(a: number): void (+1 overload)", "");
