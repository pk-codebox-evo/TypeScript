...
verify.quickInfoAt("2", "namespace m1", "NamespaceComment");
verify.quickInfoAt("3", 'import extMod = require("./commentsImportDeclaration_file0")', "Import declaration");
...
verify.quickInfoAt("8q", "function extMod.m1.fooExport(): number", "exported function");

verify.quickInfoAt("9", "var newVar: extMod.m1.m2.c", "");
